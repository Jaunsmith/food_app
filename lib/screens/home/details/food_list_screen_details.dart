...
class FoodListPageDetails extends StatelessWidget {
  const FoodListPageDetails({
    super.key,
    required this.index,
  ...
  Widget build(BuildContext context) {
    var productLists =
        Get.find<FoodListController>().foodListProductList[index];
